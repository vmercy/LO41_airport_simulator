...
void initializeData()
{
    ...
    BSL_pref_route[0].point_indexes[0] = 0;
    BSL_pref_route[0].point_indexes[1] = 2;
    BSL_pref_route[0].point_indexes[2] = 1;
    BSL_pref_route[1].point_indexes[0] = 0;
    BSL_pref_route[1].point_indexes[1] = 3;
    BSL_pref_route[1].point_indexes[2] = -1;
    BSL_pref_route[2].point_indexes[0] = 6;
    BSL_pref_route[2].point_indexes[1] = 5;
    BSL_pref_route[2].point_indexes[2] = 4;
